  ...
  return (
    <div className='mx-auto max-w-[1240px] flex items-end'>
        ...
        <div className='mt-[-96px] w-full h-screen text-center flex flex-col justify-center'>
            ...
            <button className='bg-[#32C6DA] w-[180px] rounded-md font-medium my-6 mx-auto py-3 text-[ #053B50] font-outfit text-1.5xl transition-transform duration-300 ease-in-out hover:scale-110'> 
                Get Started 
            </button>
        </div>
        </div>
